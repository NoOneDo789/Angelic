...
(* Definition ptrsub (v w: aval) := if Archi.ptr64 then subl v w else sub v w. *)

(* Lemma ptrsub_sound: *)
(*   forall v w x y, vmatch v x -> vmatch w y -> vmatch (Val.psub v w) (ptrsub x y). *)
(* Proof. *)
(*   intros. unfold Val.psub, ptrsub. destruct Archi.ptr64. *)
(*   - eapply subl_sound; eauto. *)
(*   - eapply sub_sound; eauto. *)
(* Qed. *)
