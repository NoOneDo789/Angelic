...
Proof.
  induction 2; intros; inv MS; EliminatedInstr.
...
- (* external call *)
  exploit external_call_mem_extends; eauto.
  intros [S_tgt [res' [m2' [A [A' [B [C D]]]]]]].
  des.
  left. exists (Returnstate s' res' m2'); split.
  simpl. econstructor; try eapply A'; eauto.
  eapply internal_singleton; eauto.
  eapply external_call_symbols_preserved; eauto. apply senv_preserved.
  constructor; auto.
...
Lemma match_states_gsim
  ...
  :
    gsim (RTL.rsemantics prog) (RTL.rsemantics tprog) lt (measure st_src0)%nat st_src0 st_tgt0.
Proof.
