...
Definition int2ptr_operation (vl: list val) (m: mem) : list val :=
  match vl with
  | v::nil => Mem.int2ptr_list v m
  | _ => []
  end.
...
Definition eval_operation
  ...
  | Opsub, v1::v2::null => if Archi.ptr64 then Some (Val.subl v1 v2) else Some (Val.sub v1 v2)
...
Proof with (try exact I; try reflexivity).
  ...
  (* psub begin *)
  unfold Val.subl, Val.has_type; destruct Archi.ptr64, v0, v1... destruct (eq_block b b0)...
  unfold Val.sub, Val.has_type. ss.
  (* psub end *)
  destruct v0...
  destruct v0...
  destruct v0; destruct v1...
...
Lemma int2ptr_operation_inject
  vl1 vl2 v1 m1 m2
  (INJ: Val.inject_list f vl1 vl2)
  (MEM: Mem.inject f m1 m2)
  (I2P: In v1 (int2ptr_operation vl1 m1)):
  exists v2, <<I2P: In v2 (int2ptr_operation vl2 m2)>> /\ <<INJ: Val.inject f v1 v2>>.
Proof.
  inv INJ; ss. inv H0; ss.
  eapply Mem.int2ptr_list_inject; eauto.
Qed.
